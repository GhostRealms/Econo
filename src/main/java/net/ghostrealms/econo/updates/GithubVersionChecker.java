package net.ghostrealms.econo.updates;

import com.google.gson.JsonArray;
import com.google.gson.JsonElement;
import com.google.gson.JsonObject;
import com.google.gson.JsonParser;
import net.ghostrealms.econo.utils.WebUtils;
...
public class GithubVersionChecker {
    public static final String DOWNLOAD_URL = "https://github.com/AppleDash/Econo/releases";
    private static final String RELEASES_URL = "https://api.github.com/repos/AppleDash/Econo/releases";
    ...
    public static void checkUpdateAvailable() {
        ...
        int currentVersion = releaseToInt(Econo.getInstance().getDescription().getVersion());
        int newestVersion = -1;
