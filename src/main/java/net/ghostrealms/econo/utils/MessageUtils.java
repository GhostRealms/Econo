...
import static net.ghostrealms.econo.utils.I18n._;
...
public class MessageUtils {
     ...
     * This message will have the prefix defined in Econo's config file.
    ...
    public static void sendMessage(CommandSender target, String fmt, Object... args) {
        fmt = _(fmt);
        String prefix = ChatColor.translateAlternateColorCodes('&', Econo.getInstance().getConfig().getString("chat.prefix", ""));
